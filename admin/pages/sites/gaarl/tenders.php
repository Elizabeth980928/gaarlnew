                                ...
                                <div class="col-sm-3">
                                    <label>Group</label>
                                        <select class="form-control legisChoose" id="tenders" onchange="return allowPost();" name="groupTenders">
                                            ...
                                            <option value="tender_adverts" <?php if(@$_POST['groupTenders'] == 'advertised_tender') { ?> selected <?php } ?> >advertised Tenders </option>
                                            <option value="tender_awarded" <?php if(@$_POST['groupTenders'] == 'awarded_tender') { ?> selected <?php } ?> >Awarded Tenders</option>
                                            <option value="quotation" <?php if(@$_POST['groupTenders'] == 'Bids_received') { ?> selected <?php } ?> >Bids received</option>
                                            <option value="tender_documents" <?php if(@$_POST['groupTenders'] == 'Achieved_tender') { ?> selected <?php } ?> >Achieved Tender</option>
