                                ...
                                <div class="col-sm-3">
                                    <label>Group</label>
                                        <select class="form-control legisChoose" id="tenders" onchange="return allowPost();" name="groupCareers">
                                            ...
                                            <option value="bursary" <?php if(@$_POST['groupCareers'] == 'Advertised_Vacancies') { ?> selected <?php } ?> >Advertised Vacancies</option>
                                            <option value="vacancies" <?php if(@$_POST['groupCareers'] == 'Internships_learnerships') { ?> selected <?php } ?> >Internships Learnerships</option>
