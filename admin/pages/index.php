            ...
            <div class="col-md-4 col-md-offset-4">
                <div class="login-panel panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title"><center>Login to Gaarl upload tool</center></h3>
                    </div>
...
if(isset($_POST['login'])) {
    ...
    $sql = "SELECT name, pass FROM gaarl_users WHERE name = :uname";
    ...
    if ($db) {
        ...
        if ($users) {
            if ($encrypted_password== $users['pass']) {
                ...
                header("Location:sites/gaarl/index.php");
                ob_end_flush();
